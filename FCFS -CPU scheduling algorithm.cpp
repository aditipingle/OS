...
int main()
{
    ...
    int burst_time[]={2,3,2,4};
    int comp_time[n],waiting_time[n],tat[n];
    findCompletionTime(process,n,burst_time,comp_time);
    findTurnAroundTime(process,n,comp_time);
    findWaitingTime(process,n,comp_time,burst_time,waiting_time);
}
